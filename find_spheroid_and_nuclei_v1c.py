...
v1c is a special version for plotting on an equal x,y,z axis
...
def plot_invasion(img_contour,centroids,closest_contour_pixels,save_path,im_name,px_size_xy=1.,px_size_z=1.):
    ...
    ax = Axes3D(fig)
    ax.scatter(contour_x, contour_y, contour_z, zdir='z',s=0.4,facecolors='b',edgecolors='b',alpha=0.04)
    ...
    # ax.set_xlim(0,650.0000001)
    # ax.set_ylim(0,650.0000001)
    # ax.set_zlim(0,250.0000001)
