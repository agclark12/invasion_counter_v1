...
# Form implementation generated from reading ui file 'invasion_counter_gui_v1_1.ui'
#
# Created: Fri Jul  3 17:33:54 2015
...
class Ui_TestMainWindow(object):
    def setupUi(self, TestMainWindow):
        ...
        self.button_clear_init.setGeometry(QtCore.QRect(440, 80, 131, 32))
        self.button_clear_init.setObjectName(_fromUtf8("button_clear_init"))
        self.box_scale = QtGui.QCheckBox(TestMainWindow)
        self.box_scale.setGeometry(QtCore.QRect(450, 50, 111, 20))
        ...
        self.button_load_stk.setGeometry(QtCore.QRect(440, 10, 131, 32))
...
from MyQgraphics_widget_v2 import MyGraphicsView
